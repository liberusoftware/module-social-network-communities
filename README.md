...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-communities?sort=semver)](https://github.com/liberusoftware/module-social-network-communities/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-communities/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-communities/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-communities
```
...
<a href="https://github.com/liberusoftware/module-social-network-communities/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-communities" alt="Contributors to liberusoftware/module-social-network-communities">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-communities/graphs/contributors).
